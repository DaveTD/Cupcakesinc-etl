...
ActiveRecord::Schema.define(:version => 20120923021806) do
  ...
  create_table "product_levels", :force => true do |t|
    t.integer "product_level_id"
  ...
  add_index "product_levels", ["product_category"], :name => "index_product_levels_on_product_category"
  add_index "product_levels", ["product_level_id"], :name => "index_product_levels_on_product_level_id"
  add_index "product_levels", ["product_subcategory"], :name => "index_product_levels_on_product_subcategory"
  add_index "product_levels", ["product_type"], :name => "index_product_levels_on_product_type"
